# Foggy Configuration Menu - v3.0.0
# Usage: /function foggy:config

tellraw @a {"text":"=== Foggy v3.0.0 Configuration ===","color":"gold","bold":true}
...
tellraw @a {"":""}
tellraw @a [{"text":"[🧠 Dread Controls]","color":"red","clickEvent":{"action":"run_command","value":"/function foggy:config/dread"}}]

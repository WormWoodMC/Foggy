...
execute unless items entity @s armor.head minecraft:carved_pumpkin run execute store result score @s foggy.rng run random value 0..7
execute unless items entity @s armor.head minecraft:carved_pumpkin run execute store result score @s foggy.hp run random value 0..7
...
execute unless items entity @s armor.head minecraft:carved_pumpkin if score @s foggy.hp matches 4 at @s positioned ~8 ~ ~8 run function foggy:manifestations/tier3/false_sound_here
execute unless items entity @s armor.head minecraft:carved_pumpkin if score @s foggy.hp matches 5 at @s positioned ~-8 ~ ~8 run function foggy:manifestations/tier3/false_sound_here
execute unless items entity @s armor.head minecraft:carved_pumpkin if score @s foggy.hp matches 6 at @s positioned ~8 ~ ~-8 run function foggy:manifestations/tier3/false_sound_here
execute unless items entity @s armor.head minecraft:carved_pumpkin if score @s foggy.hp matches 7 at @s positioned ~-8 ~ ~-8 run function foggy:manifestations/tier3/false_sound_here

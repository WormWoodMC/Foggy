execute store result score @s foggy.cooldown run random value 300..600
...
execute if entity @s[nbt={active_effects:[{id:"minecraft:speed"}]}] run scoreboard players set @s foggy.cooldown 0
execute if entity @s[nbt={active_effects:[{id:"minecraft:haste"}]}] run scoreboard players set @s foggy.cooldown 0
execute if entity @s[nbt={active_effects:[{id:"minecraft:resistance"}]}] run scoreboard players set @s foggy.cooldown 0
execute if entity @s[nbt={active_effects:[{id:"minecraft:jump_boost"}]}] run scoreboard players set @s foggy.cooldown 0
execute if entity @s[nbt={active_effects:[{id:"minecraft:strength"}]}] run scoreboard players set @s foggy.cooldown 0
execute if entity @s[nbt={active_effects:[{id:"minecraft:regeneration"}]}] run scoreboard players set @s foggy.cooldown 0
